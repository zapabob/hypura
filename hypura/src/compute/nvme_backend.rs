...
///
/// **Multi-volume:** workers currently share one `model_path` (see [`IoPool::new`]). A future
/// multi-pool layout would map [`crate::scheduler::types::PrefetchOp::storage_pool_id`] to
/// distinct open files or shard offsets.
pub struct IoPool {
