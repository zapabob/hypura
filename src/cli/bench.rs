...
async fn run_async(
    ...
    if dry_run {
        ...
        println!(
            ...
            format_bytes(base_runtime.placement_summary.total_gpu_bytes),
        ...
        println!(
            ...
            context, max_tokens, base_runtime.n_gpu_layers, run_baseline
        );
        println!(
        ...
        println!(
            ...
            base_runtime.plan.residency_policy.residency_profile.label(),
            if base_runtime.placement_summary.host_pinned_active {
                "active"
            } else {
                "collapsed"
            },
