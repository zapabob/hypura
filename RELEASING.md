...
gh release create v0.7.0 `
  ...
  "target/release/hypura.exe#hypura-0.7.0-windows-x86_64.exe" `
  "hypura-desktop/src-tauri/target/release/bundle/nsis/Hypura Desktop_0.7.0_x64-setup.exe#hypura-desktop-0.7.0-windows-x64-setup.exe"
```
