...
gh release create v0.8.0 `
  ...
  "target/release/hypura.exe#hypura-0.8.0-windows-x86_64.exe" `
  "hypura-desktop/src-tauri/target/release/bundle/nsis/Hypura Desktop_0.8.0_x64-setup.exe#hypura-desktop-0.8.0-windows-x64-setup.exe"
```
