...
gh release create v0.10.0 `
  --title "Hypura v0.10.0" `
  --notes "See README and git log for changes." `
  "target/release/hypura.exe#hypura-0.10.0-windows-x86_64.exe" `
  "hypura-desktop/src-tauri/target/release/bundle/nsis/Hypura Desktop_0.10.0_x64-setup.exe#hypura-desktop-0.10.0-windows-x64-setup.exe"
```
